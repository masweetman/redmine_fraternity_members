class FraternityMembersController < ApplicationController
  ...
  def export
    ...
    @fraternity_members.each do |e|
      export_csv += e.chapter+','+e.active_number.to_s+','+e.firstname+','+e.middlename+','+e.lastname+','+e.pledge_name+','+e.mail+','+e.phone+','+e.address+','+e.graduation_year.to_s+','+e.active.to_s + "\n"
    end
